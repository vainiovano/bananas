...
// modules/objdetect/include/opencv2/objdetect/aruco_detector.hpp from the
// OpenCV project.
// It is subject to the license terms in the LICENSE file found in the
// aruco_detector directory.
#ifndef BANANAS_ARUCO_ARUCO_DETECTOR_HPP
#define BANANAS_ARUCO_ARUCO_DETECTOR_HPP
...
public:
     ...
     * @param imageSize size of the images to be analyzed
     */
    CV_WRAP
    ArucoDetector(
        ...
        const Size& imageSize = {3840, 2160});
